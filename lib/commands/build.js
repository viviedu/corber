...
module.exports = Command.extend({
  ...
  async run(options = {}) {
    const platform = await resolvePlatform(this.project, options.platform);
    throw new Error(`--- This command doesn't work anymore, run "./scripts/corber-build.sh ${platform}" instead ---`);
